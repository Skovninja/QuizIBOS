...
/**
 * This Class is derived from DBCore and therefore it is no longer usefull
 * It is primarily saved to compare the difference between the old and new
 */

public class DBQuestionOld extends DBCore {
